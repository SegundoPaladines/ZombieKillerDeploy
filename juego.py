...
class Juego:
    def __init__(self, shooter):
        ...
        self.juego_sound = pygame.mixer.Sound("sfx/juego.ogg")
        self.zombie_sound = pygame.mixer.Sound("sfx/zombie.ogg")
        self.disparo_sound = pygame.mixer.Sound("sfx/disparo.ogg")
        self.recarga_sound = pygame.mixer.Sound("sfx/recarga.ogg")
